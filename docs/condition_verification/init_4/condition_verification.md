...
seed 0, init state 4. 정책은 실행하지 않고 vanilla / perturbed 환경에 같은 시작 상태를 적용해 좌표만 비교했습니다.
...
| 1 | `y0.1` | 0.071 m | 없음 | — | `clean_source_only` | ✅ |
| 1 | `y0.2` | 0.140 m | 없음 | — | `clean_source_only` | ✅ |
| 1 | `y0.3` | 0.209 m | 없음 | — | `clean_source_only` | ✅ |
| 2 | `y0.1` | 0.070 m | 없음 | — | `clean_source_only` | ✅ |
| 2 | `y0.2` | 0.140 m | 없음 | — | `clean_source_only` | ✅ |
| 2 | `y0.3` | 0.210 m | 없음 | — | `clean_source_only` | ✅ |
| 3 | `y0.1` | 0.068 m | 없음 | — | `clean_source_only` | ✅ |
| 3 | `y0.2` | 0.128 m | 없음 | — | `clean_source_only` | ✅ |
| 3 | `y0.3` | 0.200 m | 없음 | — | `clean_source_only` | ✅ |
...
| 6 | `y0.1` | 0.067 m | 없음 | — | `clean_source_only` | ✅ |
| 6 | `y0.2` | 0.140 m | 없음 | — | `clean_source_only` | ✅ |
| 6 | `y0.3` | 0.212 m | 없음 | — | `clean_source_only` | ✅ |
| 7 | `y0.1` | 0.067 m | 없음 | — | `clean_source_only` | ✅ |
| 7 | `y0.2` | 0.142 m | 없음 | — | `clean_source_only` | ✅ |
| 7 | `y0.3` | 0.206 m | 없음 | — | `clean_source_only` | ✅ |
...
- `y0.1` — clean 10/10 task, 이동량 0.067–0.071 m
- `y0.2` — clean 9/10 task, 오염된 task: [5], 이동량 0.128–0.142 m
- `y0.3` — clean 9/10 task, 오염된 task: [5], 이동량 0.200–0.212 m
